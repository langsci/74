...
\midrule
\multicolumn{3}{l}{\sls  aa}  &  \multicolumn{3}{l}{\sls   ãã} \\[0.5pt] 
...
\multicolumn{3}{l}{\sls  ii}  &  \multicolumn{3}{l}{\sls    ĩĩ} \\[0.5pt] 
...
\multicolumn{3}{l}{\sls  uu}  &  \multicolumn{3}{l}{\sls   ũũ} \\[0.5pt] 
...
àŋmùnàŋmùnà 	& type of color  & ideo\\
\end{Qtabular} 
}
\quad
